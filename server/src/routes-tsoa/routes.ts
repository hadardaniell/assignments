...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { UsersController } from './../controllers/user.tsoa.js';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
import { expressAuthentication } from './../common/middlewares/expressAuthentication.js';
...
const models: TsoaRoute.Models = {
    ...
    "AuthResponse": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"user":{"ref":"SafeUser","required":true},"refreshToken":{"dataType":"string","required":true},"token":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "RegisterDTO": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"googleId":{"dataType":"string"},"language":{"dataType":"string"},"avatarUrl":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"name":{"dataType":"string","required":true},"password":{"dataType":"string"},"email":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "LoginDTO": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"password":{"dataType":"string"},"email":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":8388608}});
        ...
        const argsUsersController_updateProfile: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"avatarUrl":{"dataType":"string"},"name":{"dataType":"string"}}},
        };
        app.patch('/api/users/updateProfile/:id',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
        ...
        app.post('/api/users/:id/uploadAvatar',
            ...
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.uploadAvatar)),

            async function UsersController_uploadAvatar(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUsersController_uploadAvatar, request, response });
        ...
        app.post('/api/recipes/generateAIRecipes',
            ...
            ...(fetchMiddlewares<RequestHandler>(RecipeController.prototype.generateAIRecipes)),

            async function RecipeController_generateAIRecipes(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsRecipeController_generateAIRecipes, request, response });

                const controller = new RecipeController();

              await templateService.apiHandler({
                methodName: 'generateAIRecipes',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsRecipeController_uploadImage: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                file: {"in":"formData","name":"recipe_image","required":true,"dataType":"file"},
        };
        app.post('/api/recipes/:id/image',
            ...
            ...(fetchMiddlewares<RequestHandler>(RecipeController)),
            ...(fetchMiddlewares<RequestHandler>(RecipeController.prototype.uploadImage)),

            async function RecipeController_uploadImage(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsRecipeController_uploadImage, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsRecipeController_getByIds: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        ...
        app.post('/api/recipes/byIds',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(RecipeController)),
            ...(fetchMiddlewares<RequestHandler>(RecipeController.prototype.getByIds)),

            async function RecipeController_getByIds(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsRecipeController_getByIds, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsLikesController_likeRecipe: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"recipeId":{"dataType":"string","required":true},"userId":{"dataType":"string","required":true}}},
        };
        app.post('/api/likes/like',
            ...(fetchMiddlewares<RequestHandler>(LikesController)),
            ...(fetchMiddlewares<RequestHandler>(LikesController.prototype.likeRecipe)),

            async function LikesController_likeRecipe(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsLikesController_likeRecipe, request, response });

                const controller = new LikesController();

              await templateService.apiHandler({
                methodName: 'likeRecipe',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsLikesController_unlikeRecipe: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"query","name":"userId","required":true,"dataType":"string"},
                recipeId: {"in":"query","name":"recipeId","required":true,"dataType":"string"},
        };
        app.delete('/api/likes/unlike',
            ...(fetchMiddlewares<RequestHandler>(LikesController)),
            ...(fetchMiddlewares<RequestHandler>(LikesController.prototype.unlikeRecipe)),

            async function LikesController_unlikeRecipe(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsLikesController_unlikeRecipe, request, response });

                const controller = new LikesController();

              await templateService.apiHandler({
                methodName: 'unlikeRecipe',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsLikesController_isRecipeLiked: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"query","name":"userId","required":true,"dataType":"string"},
                recipeId: {"in":"query","name":"recipeId","required":true,"dataType":"string"},
        };
        app.get('/api/likes/isLiked',
            ...(fetchMiddlewares<RequestHandler>(LikesController)),
            ...(fetchMiddlewares<RequestHandler>(LikesController.prototype.isRecipeLiked)),

            async function LikesController_isRecipeLiked(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsLikesController_isRecipeLiked, request, response });

                const controller = new LikesController();

              await templateService.apiHandler({
                methodName: 'isRecipeLiked',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsLikesController_getRecipeLikesCount: Record<string, TsoaRoute.ParameterSchema> = {
                recipeId: {"in":"path","name":"recipeId","required":true,"dataType":"string"},
        };
        app.get('/api/likes/count/:recipeId',
            ...(fetchMiddlewares<RequestHandler>(LikesController)),
            ...(fetchMiddlewares<RequestHandler>(LikesController.prototype.getRecipeLikesCount)),

            async function LikesController_getRecipeLikesCount(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsLikesController_getRecipeLikesCount, request, response });

                const controller = new LikesController();

              await templateService.apiHandler({
                methodName: 'getRecipeLikesCount',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsLikesController_getUserLikes: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"path","name":"userId","required":true,"dataType":"string"},
        };
        app.get('/api/likes/byUser/:userId',
            ...(fetchMiddlewares<RequestHandler>(LikesController)),
            ...(fetchMiddlewares<RequestHandler>(LikesController.prototype.getUserLikes)),

            async function LikesController_getUserLikes(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsLikesController_getUserLikes, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsLikesController_getRecipeLikes: Record<string, TsoaRoute.ParameterSchema> = {
                recipeId: {"in":"path","name":"recipeId","required":true,"dataType":"string"},
        };
        app.get('/api/likes/byLikesRecipe/:recipeId',
            ...(fetchMiddlewares<RequestHandler>(LikesController)),
            ...(fetchMiddlewares<RequestHandler>(LikesController.prototype.getRecipeLikes)),

            async function LikesController_getRecipeLikes(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsLikesController_getRecipeLikes, request, response });

                const controller = new LikesController();

              await templateService.apiHandler({
                methodName: 'getRecipeLikes',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsAuthController_getGoogleUrl: Record<string, TsoaRoute.ParameterSchema> = {
        };
        app.get('/api/auth/google',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.getGoogleUrl)),

            async function AuthController_getGoogleUrl(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsAuthController_getGoogleUrl, request, response });
